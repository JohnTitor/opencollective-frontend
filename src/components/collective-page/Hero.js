...
class Hero extends Component {
  ...
  render() {
    ...
    const background = collective.backgroundImage ? `url(${collective.backgroundImage})` : '#000000';

    return (
      <MainContainer background={background}>
        <img src={HeroBackgroundMaskSVG} style={{ display: 'none' }} />
        <Container maxWidth={Dimensions.MAX_SECTION_WIDTH} px={Dimensions.PADDING_X} margin="0 auto">
          ...
          <Container
            ...
            mt={[3, 3, 3, 4]}
          >
            <NavBar sections={this.props.sections} selected="join-us" />
            <Box py={2} ml={3}>
              <StyledButton mx={2}>
